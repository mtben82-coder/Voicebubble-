/**
 * VoiceBubble – Preset System with Smart Enhancement Layer
 *
 * - All original presets, IDs, examples and structure preserved
 * - Adds SMART_ENGINE on top of each preset to control behaviour
 * - Safe, valid JavaScript (no placeholders, no broken syntax)
 */
...
------------------------------------------
Presets: 
magic, slightly, significantly, structured, shorter, list,
clear-concise, business, formal, simple-professional, casual,
friendly, casual-email, formal-email, journal, gratitude,
...
// ============================================================
// ORIGINAL PRESET CONFIGS (unchanged in behaviour/shape)
// ============================================================
...
export const PRESET_CONFIGS = {
  ...
  magic: {
    ...
    examples: [
      ...
      {
        input:
          'hey can you send me that file from last week the one with the budget stuff',
        output:
          'Hi,\n\nCould you please send me the budget file from last week?\n\nThank you!',
      },
    ],
    constraints:
      'Analyze the input context and choose the most appropriate format, tone, and structure. Prioritize clarity and usefulness.',
    temperature: 0.8,
    maxTokens: 600,
  },
  ...
  slightly: {
    ...
    examples: [
      {
        input:
          'Im gonna be their in about 10 min, traffic is pretty bad today',
        output:
          "I'm going to be there in about 10 minutes. Traffic is pretty bad today.",
      },
      {
        input:
          'The report needs to be done by friday but i think we can finish it tommorow if everyone helps',
        output:
          'The report needs to be done by Friday, but I think we can finish it tomorrow if everyone helps.',
      },
    ],
    constraints:
      'Only fix errors and improve clarity. Keep the original tone, style, and sentence structure. Make it feel like the same person wrote it, just more polished.',
    temperature: 0.3,
    maxTokens: 500,
  },
  ...
  significantly: {
    ...
    examples: [
      {
        input:
          "So basically we need to get this done and there's a lot of steps involved and we should probably start with the data collection thing and then after that do the analysis part",
        output:
          'To complete this project successfully, we should follow a structured approach:\n\nFirst, we\'ll focus on data collection, which forms the foundation of our analysis. Once we have comprehensive data, we can proceed to the analytical phase, where we\'ll extract meaningful insights and draw conclusions.',
      },
      {
        input:
          'I think the meeting went ok but some people seemed confused about the timeline we should probably clarify that',
        output:
          'While the meeting was generally productive, I noticed some confusion regarding our project timeline. We should send a follow-up communication to clarify the key milestones and deadlines, ensuring everyone is aligned on our schedule moving forward.',
      },
    ],
    constraints:
      'Significantly improve structure, flow, and clarity. Add professional polish. Reorganize if needed for better logic. Maintain the core message but elevate the quality substantially.',
    temperature: 0.7,
    maxTokens: 700,
  },
  ...
  structured: {
    ...
    examples: [
      {
        input:
          'We need to launch the new product next month and before that we have to finalize the design get approval from legal create marketing materials train the sales team and set up the distribution channels',
        output:
          '# Product Launch Preparation\n\n## Timeline\n- Target Launch: Next Month\n\n## Pre-Launch Requirements\n\n1. **Design Phase**\n   - Finalize product design\n\n2. **Legal & Compliance**\n   - Obtain legal approval\n\n3. **Marketing**\n   - Create marketing materials\n\n4. **Team Preparation**\n   - Train sales team\n\n5. **Operations**\n   - Set up distribution channels',
      },
      {
        input:
          "The system has several issues including slow loading times users can't login sometimes the search doesn't work and the mobile version crashes",
        output:
    ...
    constraints:
      'Use headings (# ## ###), bullet points (• or -), numbered lists, and clear sections. Create visual hierarchy. Make it scannable and organized.',
    temperature: 0.5,
    maxTokens: 600,
  },
  ...
  shorter: {
    ...
    examples: [
      {
        input:
          "I wanted to reach out to you to let you know that I'm going to be running a little bit late to our meeting this afternoon because of some unexpected traffic issues that came up on my route",
        output:
          "I'll be slightly late to our afternoon meeting due to unexpected traffic.",
      },
      {
        input:
          'We have been working on this project for several months now and we have made significant progress in many areas but there are still some challenges that we need to address before we can move forward',
        output:
          'After months of work and significant progress, we must address remaining challenges before proceeding.',
      },
    ],
    constraints:
      'Reduce text length by 40-60%. Keep all essential information. Be concise but complete. No loss of meaning.',
    temperature: 0.4,
    maxTokens: 300,
  },
  ...
  list: {
    ...
    examples: [
      {
        input:
          'I need to pick up milk eggs bread and coffee from the store and also grab some vegetables like tomatoes and lettuce',
        output:
          'Shopping List:\n• Milk\n• Eggs\n• Bread\n• Coffee\n• Tomatoes\n• Lettuce',
      },
      {
        input:
          'Today I need to finish the report send the email to the client call the vendor about the shipment and prepare for tomorrow\'s presentation',
        output:
          "Today's Tasks:\n1. Finish the report\n2. Send email to client\n3. Call vendor about shipment\n4. Prepare for tomorrow's presentation",
      },
    ],
    constraints:
      'Convert to clean list format. Use • for unordered, 1. 2. 3. for ordered lists. Keep items concise and clear. Add a list title if appropriate.',
    temperature: 0.3,
    maxTokens: 400,
  },
  ...
  'x-post': {
    ...
    examples: [
      {
        input:
          "Just realized that most people spend more time planning their vacation than planning their career and that's probably why so many people are unhappy at work",
        output:
          "Most people spend more time planning a 1-week vacation than planning their entire career.\n\nThen wonder why they're unhappy at work. 🤔",
      },
      {
        input:
          "I've been working on this project for 6 months and finally launched it today feeling excited and nervous at the same time",
        output:
          "After 6 months of building, we finally launched today.\n\nExcited, nervous, and ready to see what happens. 🚀",
      },
    ],
    constraints:
      'MUST be under 280 characters. Make it punchy and engaging. Use line breaks for readability. Maximum 1-2 emojis if they add value. No hashtags unless essential.',
    temperature: 0.8,
    maxTokens: 100,
  },
  ...
  'x-thread': {
    ...
    examples: [
      {
        input:
          "The key to productivity isn't working more hours it's about energy management you need to understand your peak performance times and schedule your most important work during those periods also take breaks and don't try to push through when you're exhausted",
        output:
          "1/4 🧵 The key to productivity isn't working more hours.\n\nIt's energy management.\n\n2/4 Most people don't realize they have peak performance windows during the day.\n\nIdentify yours. Schedule your most important work during these times.\n\n3/4 When you're exhausted, pushing through is counterproductive.\n\nYour output quality drops. You make mistakes. You waste time.\n\n4/4 Bottom line:\n• Find your peak hours\n• Schedule deep work then\n• Rest when energy is low\n\nWork smarter, not longer.",
      },
    ],
    constraints:
      'Number tweets as 1/n, 2/n, etc. Each tweet under 280 characters. Create narrative flow. Make thread engaging and valuable. First tweet must hook readers.',
    temperature: 0.7,
    maxTokens: 800,
  },
  ...
  facebook: {
    ...
    examples: [
      {
        input:
          'Just tried the new coffee shop downtown and it was amazing the cappuccino was perfect and the atmosphere was really cozy definitely going back',
        output:
          "Just discovered the best new coffee spot downtown! ☕\n\nThe cappuccino? Absolutely perfect. The atmosphere? Cozy and inviting. The kind of place where you actually want to sit and relax.\n\nDefinitely adding this to my regular rotation. If you're in the area, it's worth checking out!\n\nWhat's your favorite local coffee shop? Always looking for recommendations! 👇",
      },
    ],
    constraints:
      'Make it conversational and engaging. Use paragraph breaks for readability. 1-2 emojis maximum. Encourage interaction if appropriate. Keep it authentic and shareable.',
    temperature: 0.7,
    maxTokens: 500,
  },
  ...
  instagram: {
    ...
    examples: [
      {
        input:
          'Sunset at the beach today was incredible the colors were amazing and it was so peaceful just what I needed after a busy week',
        output:
          "Tonight's sunset was exactly what I needed 🌅\n\nAfter a chaotic week, there's something about watching the sky paint itself in shades of orange and pink that just hits different.\n\nNo agenda. No rush. Just being present.\n\nSometimes the best therapy is nature's light show ✨\n\n—\nWhere's your favorite place to reset? 👇",
      },
    ],
    constraints:
      'Use line breaks for visual appeal. 2-4 emojis that enhance the message. Be authentic and relatable. Create connection. Can end with question for engagement.',
    temperature: 0.7,
    maxTokens: 500,
  },
  ...
  'video-script': {
    ...
    examples: [
      {
        input:
          'want to make a video about productivity tips for working from home covering setting up a workspace, managing distractions, and staying motivated',
        output:
    ...
    constraints:
      'Include [INTRO], [MAIN CONTENT], and [OUTRO] sections. Add timing estimates. Include speaking cues [Pause], [Emphasize], etc. Write for spoken delivery. Make it engaging and well-structured.',
    temperature: 0.7,
    maxTokens: 1200,
  },
  ...
  journal: {
    ...
    examples: [
      {
        input:
          'today was pretty good had a productive meeting in the morning then grabbed lunch with sarah we talked about the new project feeling optimistic about it but also a bit nervous about the timeline',
        output:
    ...
    constraints:
      'Organize thoughts into coherent paragraphs. Preserve authentic voice and emotion. Add structure with sections or formatting. Keep it personal and reflective. Can include mood, gratitude, or reflection sections.',
    temperature: 0.6,
    maxTokens: 600,
  },
  ...
  gratitude: {
    ...
    examples: [
      {
        input:
          'grateful for my family today mom called and we had a nice chat also my project at work is going well and the weather was beautiful',
        output:
    ...
    constraints:
      'Focus on gratitude and appreciation. Organize by themes or categories. Be heartfelt and reflective. Help user recognize blessings. Use warm, appreciative language. Can include reflection section.',
    temperature: 0.7,
    maxTokens: 700,
  },
  ...
  'casual-email': {
    ...
    examples: [
      {
        input:
          "tell john about the schedule change for next week's meeting and see if he can still make it",
        output:
      ...
      {
        input:
          'asking lisa if she got the files i sent and if she needs anything else',
        output:
    ...
    constraints:
      'Friendly, conversational tone. Include greeting (Hi/Hey) and closing (Thanks/Cheers). Keep it warm but appropriate. Be clear and helpful. Not too formal, not too casual.',
    temperature: 0.6,
    maxTokens: 400,
  },
  ...
  'formal-email': {
    ...
    examples: [
      {
        input:
          'tell the client the project will be delayed by two weeks because of resource issues',
        output:
      ...
      {
        input:
          'ask the vendor for a quote on the new equipment we discussed',
        output:
    ...
    constraints:
      'Formal, professional tone. Include proper greeting (Dear) and closing (Best regards/Sincerely). Be polite and clear. Use professional language. Structure with proper business email format.',
    temperature: 0.5,
    maxTokens: 500,
  },
  ...
  'short-summary': {
    ...
    constraints:
      'Extract only key points. Be extremely concise. Use bullet points. No fluff. Capture essence in minimal words. Perfect for quick scanning.',
    temperature: 0.3,
    maxTokens: 300,
  },
  ...
  business: {
    ...
    examples: [
      {
        input:
          "we really need to get this done soon because it's becoming a problem and affecting other stuff",
        output:
          'This issue requires immediate attention as it is currently impacting our broader operations and team productivity. We should prioritize resolution to prevent further downstream effects.',
      },
      {
        input:
          'the meeting went well and everyone seemed happy with the plan',
        output:
          'The meeting concluded successfully with strong stakeholder alignment on the proposed strategy. All participants expressed support for moving forward with the outlined plan.',
      },
    ],
    constraints:
      'Professional business tone. Clear and direct. Results-oriented language. Appropriate for corporate communications. Organized and effective.',
    temperature: 0.5,
    maxTokens: 500,
  },
  ...
  formal: {
    ...
    examples: [
      {
        input:
          "i can't make it to the meeting tomorrow sorry about the short notice",
        output:
          'I regret to inform you that I will be unable to attend tomorrow\'s scheduled meeting. Please accept my apologies for this late notification. I would be grateful if arrangements could be made to brief me on the proceedings at a later time.',
      },
      {
        input:
          'we need to talk about the contract because there are some issues we need to fix',
        output:
          'It has come to our attention that the current contract contains certain provisions that require amendment. We respectfully request a formal discussion to address these matters and work toward a mutually agreeable resolution.',
      },
    ],
    constraints:
      'Highly formal tone. Sophisticated vocabulary. Traditional formal structures. Suitable for official/governmental communication. Extremely polite and proper.',
    temperature: 0.4,
    maxTokens: 500,
  },
  ...
  casual: {
    ...
    examples: [
      {
        input:
          'I am writing to inform you that I will be unable to attend the scheduled meeting due to a prior commitment',
        output:
          "Hey, just wanted to let you know I can't make it to the meeting - I've got something else I need to take care of. Sorry about that!",
      },
      {
        input:
          'We should reconvene next week to discuss the outstanding issues',
        output:
          "Let's chat next week about those things we still need to figure out. Sound good?",
      },
    ],
    constraints:
      'Informal, relaxed tone. Conversational and friendly. Easy-going language. Write naturally. No strict formalities.',
    temperature: 0.7,
    maxTokens: 400,
  },
  ...
  friendly: {
    ...
    examples: [
      {
        input:
          "I wanted to update you on the status of the project and let you know we're making good progress",
        output:
          "Hey! Just wanted to give you a quick update - the project's going really well! We're making awesome progress and I'm pretty excited about how it's turning out. Thought you'd want to know!",
      },
      {
        input:
          'Thank you for your assistance with this matter it was very helpful',
        output:
          "Thanks so much for helping me out with this! You're a lifesaver, seriously. Really appreciate you!",
      },
    ],
    constraints:
      'Warm and friendly like talking to a close friend. Personal and genuine. Conversational tone. Show enthusiasm and personality. Natural language.',
    temperature: 0.7,
    maxTokens: 400,
  },
  ...
  'clear-concise': {
    ...
    examples: [
      {
        input:
          'In order to ensure that we are able to meet the deadline, it would be beneficial if we could all work together to complete the remaining tasks as efficiently as possible',
        output:
          'To meet the deadline, we need to efficiently complete the remaining tasks together.',
      },
      {
        input:
          'I was wondering if you might be able to possibly help me with this issue at some point when you have a chance',
        output: 'Can you help me with this when you\'re available?',
      },
    ],
    constraints:
      'Maximum clarity and conciseness. Remove filler words. Use direct language. Simplify complex phrases. Get to the point. Every word must add value.',
    temperature: 0.3,
    maxTokens: 300,
  },

  // ===== HOLIDAY / TONE PRESETS =====
  funny: {
    ...
    examples: [
      ...
      {
        input:
          "wishing you a happy new year hope it's better than this one",
        output:
    ...
    constraints:
      'Add humor and wit. Keep it lighthearted and playful. Make it funny but appropriate. Balance cleverness with warmth. Can use emojis for effect.',
    temperature: 0.8,
    maxTokens: 400,
  },
  ...
  warm: {
    ...
    constraints:
      'Genuinely warm and heartfelt. Personal and sincere. Show authentic care. Create emotional connection. Use warm, friendly language.',
    temperature: 0.7,
    maxTokens: 400,
  },
  ...
  'simple-professional': {
    ...
    constraints:
      'Simple and professional. Polite and appropriate for business. Brief but warm. Professional greeting and closing.',
    temperature: 0.5,
    maxTokens: 300,
  },
  ...
  outline: {
    ...
    examples: [
      {
        input:
          'need to write an article about starting a small business covering the planning phase getting funding setting up operations and marketing',
        output:
    ...
    constraints:
      'Use hierarchical structure with Roman numerals (I, II), letters (A, B), and numbers (1, 2). Create multiple levels of depth. Make it comprehensive and ready for expansion. Clear organization.',
    temperature: 0.5,
    maxTokens: 800,
  },
};
